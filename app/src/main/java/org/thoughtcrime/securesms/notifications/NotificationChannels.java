...
public class NotificationChannels {
  ...
  private static void onCreate(@NonNull Context context, @NonNull NotificationManager notificationManager) {
    ...
    NotificationChannel other        = new NotificationChannel(OTHER, context.getString(R.string.MessageRetrievalService_background_connection_enabled), NotificationManager.IMPORTANCE_LOW);
